...
<div class="container">
    ...
    <div class="card">
        <div class="card-body p-0 overflow-hidden">
            <div class="row cover">
                <img src="{{ url('/img/' . $coverImg) }}" alt=""
                    style="width: 100%; height: 150px; background-position: center; object-fit: cover">
            </div>
            <div class="row align-items-end px-3" style="position: relative; top: -30px">
                ...
                <div class="col justify-content-lg-end d-flex mt-3">
                    <a href="/user/{{ $user->id }}/edit" class="btn btn-outline-primary"><i class="fas fa-pen"></i> Edit
                        Profile</a>
                        <a href="/user/{{ $user->id }}/edit/password" class="btn btn-outline-primary ml-2">Ganti Password</a>
                </div>
                @endif
